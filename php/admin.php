...
<head>
    ...
    <title>Koperasi prof Antony anggrawan </title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav btn-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Koperasi Kesayangan Anda</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow btn-success">
